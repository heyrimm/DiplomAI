...
| 공공외교 현황 | 공공외교 지수 · 세종학당 수강생 · 재외동포 · 재외공관 · 한국학 대학 · KF 사업 이력 | 세종학당 CSV · 재외동포 CSV · 재외공관 API · KF CSV 2종 |
| **공공외교 공백 신호** | ODA 지원은 활발한데 KF 공공외교 사업이 없거나 중단된 국가 자동 감지 | KOICA CSV + KF 융합 사업정보 교차 분석 |
...
주관 4개 기관(외교부·KOICA·KF·한아프리카재단)의 개방데이터를 모두 활용합니다.
...
| KOICA 지역별 지원실적 통계 | data.go.kr (한국국제협력단) | CSV |
| KF 융합 공공외교·ODA 사업정보 (11,782건) | data.go.kr (한국국제교류재단) | CSV |
| KF 해외대학 한국학 과정 운영현황 (1,421건) | data.go.kr (한국국제교류재단) | CSV |
| 한아프리카재단 지자체-아프리카 교류협력 사례 | data.go.kr (한·아프리카재단) | CSV |
